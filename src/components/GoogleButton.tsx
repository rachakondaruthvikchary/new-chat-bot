...
export default function GoogleButton({ label }: { label: string }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="flex w-full items-center justify-center gap-2 rounded-xl border border-border bg-surface px-6 py-3 font-medium text-foreground transition hover:bg-background"
    >
